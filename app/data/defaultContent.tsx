      ...
      options: {
        ...
        online: {
          ...
          slides: [
            ...
            {
              src: '/images/services/online/4.webp',
              alt: 'Рабочее место',
              width: 4032,
              height: 3024,
            },
        ...
        yourHome: {
          ...
          content: {
            ...
            attention:
              'Стоимость занятий может варьироваться в зависимости от времени, затраченного на дорогу туда и обратно, а также от удаленности района. 🚗⏳ Я всегда готова обсудить условия, чтобы ваш ребенок получал качественные уроки без лишних неудобств!',
          },
          slides: [],
        },
      },
