      ...
      options: {
        myHome: {
          ...
          content: {
            ...
            price: 1300,
            discount: 'На первое занятие и все уроки в период каникул — скидка 20%! 🎉📚✨',
            ...
            call_to_action:
              'Занятия с репетитором дома — это не просто обучение, это путь к уверенности и успеху в математике. Я буду рада помочь вашему ребенку раскрыть свои возможности и почувствовать, как приятно достигать новых вершин в учебе! 🌟',
          },
          slides: [
            {
        ...
        yourHome: {
          ...
          content: {
            ...
            description:
              'Занятия с выездом — идеальный вариант для тех, кто хочет, чтобы репетитор приезжал прямо к вам домой, не теряя при этом качества и эффективности обучения. Я приеду к вам и проведу урок в удобной обстановке, уделяя внимание каждому моменту и создавая атмосферу для комфортного освоения математики. 📍',
            features: [
              ...
              '💡 Уроки, построенные так, чтобы ребенок не просто учил формулы, а понимал логику решения задач и их применение.',
            ...
            price: 1500,
            discount: 'На первое занятие и все уроки в период каникул — скидка 20%! 🎉📚✨',
            goal: 'Я всегда готова приехать и создать комфортные условия для обучения, где ваш ребенок сможет не только разобраться в сложных темах, но и полюбить математику. Вместе мы сделаем так, чтобы он чувствовал себя уверенно и с каждым занятием становился все сильнее в этом важном предмете. 🎓',
            call_to_action:
        ...
        online: {
          ...
          content: {
            ...
            price: 1000,
            discount: 'На первое занятие и все уроки в период каникул — скидка 20%! 🎉📚✨',
            goal: 'Мы начнем с первого занятия, чтобы узнать больше о сильных и слабых сторонах ученика, определить, какие темы вызывают трудности, и построить индивидуальный план обучения. Моя задача — не просто помочь решить задачи, а сделать так, чтобы математика стала понятной и даже интересной! 🌟',
            call_to_action:
