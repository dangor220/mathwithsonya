...
export const metadata: Metadata = {
  title: 'Софья Алексеевна • Репетитор по математике 4–9 классы • Москва и онлайн',
  description:
    'Репетитор по математике Софья Алексеевна — занятия для учеников 4–9 классов. Онлайн, с выездом и у преподавателя в Москве: Бунинские Луга, рядом с Коммунаркой, Потапово и метро Новомосковская.',
  keywords: [
  ...
  openGraph: {
    title:
      'Софья Алексеевна — Репетитор по математике в Москве (Бунинские Луга, Коммунарка, Потапово, Александры Монаховой)',
    description:
